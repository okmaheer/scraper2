                ...
                <div class="row g-9 mb-8">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control form-control-solid required" name="duration">
                            ...
                            <option value="1" {{$user->duration == '1' ? 'selected' : ''}}>15 Days</option>
                            <option value="2" {{$user->duration == '2' ? 'selected' : ''}}>1 Month</option>
                            <option value="3" {{$user->duration == '3' ? 'selected' : ''}}>2 Month</option>
                            <option value="4" {{$user->duration == '4' ? 'selected' : ''}}>3 Month</option>
                            <!-- Add more options as needed -->
                        </select>
                    </div>
